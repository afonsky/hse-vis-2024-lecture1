...
* Мы можем использовать эволюционно приобретенные **способности к нахождению паттернов** <span v-mark="{ at: 10, color: 'green', type: 'underline' }">нашей</span> зрительной системы
